A weather application that draws data from a weather api. The website takes in a live location, from the user and uses said input to draw the specefic data
